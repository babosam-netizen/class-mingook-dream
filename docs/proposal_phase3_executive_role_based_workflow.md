...
### 5.1 [scaffolding-data.js](app/src/lib/scaffolding-data.js) 수정
...
### 5.2 [BranchUnitWorkspace.jsx](app/src/components/phase3/BranchUnitWorkspace.jsx) 수정
...
### 5.3 [ExecutiveTab.jsx](app/src/components/phase3/ExecutiveTab.jsx) 및 [ExecutivePolicyBudgetDraft.jsx](app/src/components/phase3/ExecutivePolicyBudgetDraft.jsx) 수정
